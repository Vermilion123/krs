...
public Create_Docs(WebDriver driver, String doc_type, String search_key, String cmp_name_search_key, Boolean set_fields){
    	...
    	$("[class='k-formatted-value invoice-row-amount k-input required']").click();
    	$(By.name("row-amount-1")).val("50");
    	$("[class='k-widget k-numerictextbox invoice-row-netSum']").click();
